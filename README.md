...
[![Android CI](https://github.com/kocielnik/Ghost-Android/actions/workflows/android.yml/badge.svg)](https://github.com/kocielnik/Ghost-Android/actions/workflows/android.yml)
...
Copyright (c) 2013-2023 Vicky Chijwani & Ghost Foundation - Released under the [MIT license](LICENSE).

Ghost and the Ghost Logo are trademarks of Ghost Foundation Ltd.

Please see our [trademark policy](https://ghost.org/trademark/) for info on acceptable usage.
